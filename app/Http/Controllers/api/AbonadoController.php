...
class AbonadoController extends ApiResponseController
{
    ...
    //     $extension = explode('/', mime_content_type($data->base64_image))[1];
        
    //     dd($base64_str,$extension);
    //     $image = base64_decode($base64_str);

    //     $hash = "img.png";
    //     file_put_contents(public_path()."\abonados\\".$hash,$image);
    //     $response = array(
    //         'status' => 'success',
    //     );
    //     return $this->successResponse( $response ," succes" );
    // }
